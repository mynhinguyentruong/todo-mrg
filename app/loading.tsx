export default function Loading() {
    return (
        <div role="status" className="animate-pulse py-64 ">
            ...
            <div className="h-2.5 mx-auto my-3 bg-gray-300 rounded-full dark:bg-gray-700 max-w-[440px]"></div>
            <div className="h-2.5 mx-auto my-3 bg-gray-300 rounded-full dark:bg-gray-700 max-w-[340px]"></div>
